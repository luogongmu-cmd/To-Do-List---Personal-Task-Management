...
export default function MainLayout({
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* 跳转链接 */}
      <a href="#main-content" className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-50 focus:px-4 focus:py-2 focus:bg-card focus:shadow-md">
        跳转到主要内容
      </a>
